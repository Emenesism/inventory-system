    ...
    "Analytics": HelpContent(
        ...
        body=_wrap(
            _t(
                ...
                <h3>دکمه اصلی</h3>
                <ul>
                    <li><b>بروزرسانی:</b> محاسبه مجدد آمار و جدول‌ها با آخرین داده‌ها.</li>
                </ul>

                <h3>موارد قابل مشاهده</h3>
                <ul>
                    <li>جمع فروش، جمع خرید، سود و تعداد کل فاکتورها.</li>
                    <li>جدول ماهانه شامل فروش، خرید، سود و تعداد فاکتور.</li>
                    <li>ستون «روند» برای مقایسه سریع ماه‌ها.</li>
                </ul>
                """
            )
        ),
